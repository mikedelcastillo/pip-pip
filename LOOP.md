...
| 130| (latest)    | Map render Phase 2: tiles carry shape+block; renderer draws diagonals as triangles (matching segWalls) + block variety, as ONE cacheAsBitmap layer rebuilt only on setMap (fast big maps) | `git revert <sha>` |
