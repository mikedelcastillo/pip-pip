...
| 131| (latest)    | Map editor Phase 3: homepage /editor route + Map Maker button; paint grid (full/4 slopes/deco/spawn) via pointer events (touch), name/size, collision preview, download/import GridMapData JSON | `git revert <sha>` |
