...
| 132| (latest)    | Map editor pan/zoom: native Mac trackpad scroll=pan + ctrl/pinch=zoom (passive:false wheel), two-finger touch pinch/pan, one-finger paints; Fit view button | `git revert <sha>` |
