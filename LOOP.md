...
| 135| (latest)    | Aseprite-style map editor: full-screen canvas + checkerboard, vertical tool rail, options popover, keyboard shortcuts + tooltips, click-drag, leave-confirm (ConfirmModal + beforeunload), localStorage autosave/restore | `git revert <sha>` |
