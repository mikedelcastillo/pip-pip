...
| 136| (latest)    | Auto-slope editor tool: picks the slope direction from neighbouring walls (autoSlopeShape, pure+tested); the 4 explicit directions tucked in a dropdown (fixed-positioned to escape rail clip) under it; shortcut S=auto, Q/W/A/X directions | `git revert <sha>` |
