...
| 108| (latest)    | Team Deathmatch mode (2 balanced teams, team scoring to maxKills, friendly-fire off, team HUD + player list grouping, host/lobby config) | `git revert <sha>` |
