...
| 121| (latest)    | FIX A* nav over-blocked corridors (bots got stuck / drove into walls): cell-CENTRE sampling + correct clearance (ship radius + wall radius, was a full diameter) + finer cells (0.75x, was 1.75x wider than a corridor) | `git revert <sha>` |
